...
#include "É±»ú_BP_Menu_Slasher06_parameters.hpp"
...
void ABP_Menu_Slasher06_C::ReceiveBeginPlay()
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher06.BP_Menu_Slasher06_C.ReceiveBeginPlay"));
...
void ABP_Menu_Slasher06_C::ExecuteUbergraph_BP_Menu_Slasher06(int* EntryPoint)
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher06.BP_Menu_Slasher06_C.ExecuteUbergraph_BP_Menu_Slasher06"));
