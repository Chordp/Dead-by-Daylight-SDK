...
#include "É±»ú_QueryService_structs.hpp"
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("Class QueryService.ActorPairQueryEvaluatorComponent"));
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("Class QueryService.ActorPairQueryEvaluatorSubscriberTest"));
