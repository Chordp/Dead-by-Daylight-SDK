...
{
public:
	struct FEditableTextBoxStyle                       EditableTextBoxStyle;                                     // 0x0038(0x0860) (Edit)
...
{
public:
	struct FEditableTextStyle                          EditableTextStyle;                                        // 0x0038(0x0238) (Edit)
...
{
public:
	bool                                               bExplicitCanvasChildZOrder;                               // 0x0030(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
...
{
public:
	struct FTextBlockStyle                             TextBlockStyle;                                           // 0x0038(0x0288) (Edit)
