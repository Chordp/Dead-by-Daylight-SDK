...
#include "É±»ú_BP_Menu_Slasher09_parameters.hpp"
...
void ABP_Menu_Slasher09_C::ReceiveBeginPlay()
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher09.BP_Menu_Slasher09_C.ReceiveBeginPlay"));
...
void ABP_Menu_Slasher09_C::ExecuteUbergraph_BP_Menu_Slasher09(int* EntryPoint)
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher09.BP_Menu_Slasher09_C.ExecuteUbergraph_BP_Menu_Slasher09"));
