...
struct FMovieSceneEvaluationTrack
{
	...
	unsigned char                                      UnknownData01[0x4];                                       // 0x00E8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bEvaluateInPreroll : 1;                                   // 0x00F4(0x0001)
	unsigned char                                      bEvaluateInPostroll : 1;                                  // 0x00F4(0x0001)
...
{
	struct FSoftObjectPath                             Sequence;                                                 // 0x0000(0x0020) (ZeroConstructor)
	struct FMovieSceneSequenceTransform                RootToSequenceTransform;                                  // 0x0020(0x000C)
	struct FFrameRate                                  TickResolution;                                           // 0x002C(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FMovieSceneSequenceID                       DeterministicSequenceID;                                  // 0x0034(0x0004)
	struct FMovieSceneFrameRange                       PlayRange;                                                // 0x0038(0x0010)
	struct FMovieSceneFrameRange                       PreRollRange;                                             // 0x0048(0x0010)
	struct FMovieSceneFrameRange                       PostRollRange;                                            // 0x0058(0x0010)
	int                                                HierarchicalBias;                                         // 0x0068(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x006C(0x0004) MISSED OFFSET
	struct FMovieSceneSequenceInstanceDataPtr          InstanceData;                                             // 0x0070(0x0018)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0088(0x0008) MISSED OFFSET
	struct FGuid                                       SubSectionSignature;                                      // 0x0090(0x0010) (ZeroConstructor, IsPlainOldData)
	struct FMovieSceneSequenceTransform                OuterToInnerTransform;                                    // 0x00A0(0x000C)
...
struct FMovieSceneSpawnable
{
	...
	struct FName                                       LevelName;                                                // 0x007C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0079(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	struct FFrameNumber                                FrameNumber;                                              // 0x0000(0x0004) (Edit)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FString                                     Label;                                                    // 0x0008(0x0010) (Edit, ZeroConstructor)
};
...
{
	unsigned char                                      UnknownData00[0x30];                                      // 0x0000(0x0030) UNKNOWN PROPERTY: SoftObjectProperty MovieScene.MovieSceneObjectPathChannelKeyValue.SoftPtr
	class UObject*                                     HardPtr;                                                  // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
struct FMovieSceneObjectPathChannel : public FMovieSceneChannel
{
	...
	struct FMovieSceneObjectPathChannelKeyValue        defaultValue;                                             // 0x0030(0x0038)
...
struct FMovieScenePropertySectionData
{
	...
	struct FString                                     PropertyPath;                                             // 0x0010(0x0010) (ZeroConstructor)
	...
	struct FName                                       NotifyFunctionName;                                       // 0x002C(0x0008) (ZeroConstructor, IsPlainOldData)
