...
#include "É±»ú_ActionSpeedProficiency_parameters.hpp"
...
EStatusEffectType UActionSpeedProficiency_C::GetType(float* value)
{
	static UFunction* fn;
	...
	UActionSpeedProficiency_C_GetType_Params params;
	params.value = value;
...
int UActionSpeedProficiency_C::GetLevel(class UChargeableInteractionDefinition** chargeableInteraction, class ADBDPlayer** Player)
{
	static UFunction* fn;
	...
	UActionSpeedProficiency_C_GetLevel_Params params;
	params.chargeableInteraction = chargeableInteraction;
	params.Player = Player;
...
bool UActionSpeedProficiency_C::GetIsActive(class UChargeableInteractionDefinition** chargeableInteraction, class ADBDPlayer** Player)
{
	static UFunction* fn;
	...
	UActionSpeedProficiency_C_GetIsActive_Params params;
	params.chargeableInteraction = chargeableInteraction;
	params.Player = Player;
