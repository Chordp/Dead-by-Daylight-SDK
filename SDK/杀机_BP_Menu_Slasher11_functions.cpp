...
#include "É±»ú_BP_Menu_Slasher11_parameters.hpp"
...
void ABP_Menu_Slasher11_C::ReceiveBeginPlay()
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher11.BP_Menu_Slasher11_C.ReceiveBeginPlay"));
...
void ABP_Menu_Slasher11_C::ExecuteUbergraph_BP_Menu_Slasher11(int* EntryPoint)
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher11.BP_Menu_Slasher11_C.ExecuteUbergraph_BP_Menu_Slasher11"));
