...
#include "É±»ú_BP_Menu_Slasher01_parameters.hpp"
...
void ABP_Menu_Slasher01_C::ReceiveBeginPlay()
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher01.BP_Menu_Slasher01_C.ReceiveBeginPlay"));
...
void ABP_Menu_Slasher01_C::ExecuteUbergraph_BP_Menu_Slasher01(int* EntryPoint)
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher01.BP_Menu_Slasher01_C.ExecuteUbergraph_BP_Menu_Slasher01"));
