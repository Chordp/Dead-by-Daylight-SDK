...
#include "É±»ú_BP_Menu_Slasher02_parameters.hpp"
...
void ABP_Menu_Slasher02_C::ReceiveBeginPlay()
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher02.BP_Menu_Slasher02_C.ReceiveBeginPlay"));
...
void ABP_Menu_Slasher02_C::ExecuteUbergraph_BP_Menu_Slasher02(int* EntryPoint)
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher02.BP_Menu_Slasher02_C.ExecuteUbergraph_BP_Menu_Slasher02"));
