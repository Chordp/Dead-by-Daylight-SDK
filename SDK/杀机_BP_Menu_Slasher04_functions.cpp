...
#include "É±»ú_BP_Menu_Slasher04_parameters.hpp"
...
void ABP_Menu_Slasher04_C::ReceiveBeginPlay()
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher04.BP_Menu_Slasher04_C.ReceiveBeginPlay"));
...
void ABP_Menu_Slasher04_C::ExecuteUbergraph_BP_Menu_Slasher04(int* EntryPoint)
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher04.BP_Menu_Slasher04_C.ExecuteUbergraph_BP_Menu_Slasher04"));
