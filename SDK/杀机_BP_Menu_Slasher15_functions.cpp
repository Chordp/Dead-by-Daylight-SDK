...
#include "É±»ú_BP_Menu_Slasher15_parameters.hpp"
...
void ABP_Menu_Slasher15_C::ReceiveBeginPlay()
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher15.BP_Menu_Slasher15_C.ReceiveBeginPlay"));
...
void ABP_Menu_Slasher15_C::ExecuteUbergraph_BP_Menu_Slasher15(int* EntryPoint)
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher15.BP_Menu_Slasher15_C.ExecuteUbergraph_BP_Menu_Slasher15"));
