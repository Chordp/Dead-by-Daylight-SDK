...
#include "É±»ú_BP_Menu_Slasher14_structs.hpp"
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_Menu_Slasher14.BP_Menu_Slasher14_C"));
	...
	void ExecuteUbergraph_BP_Menu_Slasher14(int* EntryPoint);
};
