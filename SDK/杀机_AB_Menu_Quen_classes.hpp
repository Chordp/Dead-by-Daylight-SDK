...
#include "É±»ú_AB_Menu_Quen_structs.hpp"
...
// AnimBlueprintGeneratedClass AB_Menu_Quen.AB_Menu_Quen_C
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass AB_Menu_Quen.AB_Menu_Quen_C"));
