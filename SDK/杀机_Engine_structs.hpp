...
#include "杀机_AudioPlatformConfiguration_classes.hpp"
#include "杀机_SlateCore_classes.hpp"
#include "杀机_PacketHandler_classes.hpp"
...
// Enum Engine.ELocationStaticVertSurfaceSource
...
// Enum Engine.ECustomColourWriteMask
enum class ECustomColourWriteMask : uint8_t
{
	ECCWM_RGBA                     = 0,
	ECCWM_A                        = 1,
	ECCWM_MAX                      = 2
...
// Enum Engine.EDetailModeBitMask
...
// Enum Engine.ELightingDetailMode
...
enum class EMaterialProperty : uint8_t
{
	...
	MP_CustomColour                = 27,
	MP_CustomColourClip            = 28,
	MP_CustomColourNoDepth         = 29,
	MP_CustomColourNoDepthClip     = 30,
...
struct FRepAttachment
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FHitResult
{
	...
	unsigned char                                      UnknownData01[0x4];                                       // 0x0078(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       MyBoneName;                                               // 0x0084(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0084(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
struct FChannelDefinition
{
	...
	struct FName                                       ClassName;                                                // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	class UClass*                                      ChannelClass;                                             // 0x0018(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                StaticChannelIndex;                                       // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bTickOnCreate;                                            // 0x0024(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bServerOpen;                                              // 0x0025(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bClientOpen;                                              // 0x0026(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bInitialServer;                                           // 0x0027(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bInitialClient;                                           // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FSimpleMemberReference
{
	...
	struct FGuid                                       MemberGuid;                                               // 0x0014(0x0010) (ZeroConstructor, IsPlainOldData)
...
struct FResponseChannel
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<ECollisionResponse>                    response;                                                 // 0x000C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FBodyInstance
{
	...
	unsigned char                                      UnknownData06[0x4];                                       // 0x000F(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
// ScriptStruct Engine.TresholdToFrameSkip
// 0x0008
struct FTresholdToFrameSkip
{
	struct FPerPlatformFloat                           Treshold;                                                 // 0x0000(0x0004) (Edit, DisableEditOnInstance)
	struct FPerPlatformInt                             FrameSkip;                                                // 0x0004(0x0004) (Edit, DisableEditOnInstance)
};
...
struct FSkeletalMaterial
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FMeshUVChannelInfo                          UVChannelData;                                            // 0x0014(0x0014) (Edit, BlueprintVisible, BlueprintReadOnly, EditConst)
};
...
struct FSkeletalMeshLODInfo
{
	...
	struct FSkeletalMeshOptimizationSettings           ReductionSettings;                                        // 0x0018(0x003C) (Edit)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0054(0x0004) MISSED OFFSET
	TArray<struct FBoneReference>                      BonesToRemove;                                            // 0x0058(0x0010) (Edit, ZeroConstructor)
	TArray<struct FBoneReference>                      BonesToPrioritize;                                        // 0x0068(0x0010) (Edit, ZeroConstructor)
	float                                              WeightOfPrioritization;                                   // 0x0078(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x007C(0x0004) MISSED OFFSET
	class UAnimSequence*                               BakePose;                                                 // 0x0080(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UAnimSequence*                               BakePoseOverride;                                         // 0x0088(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FString                                     SourceImportFilename;                                     // 0x0090(0x0010) (Edit, ZeroConstructor, EditConst)
	unsigned char                                      bHasBeenSimplified : 1;                                   // 0x00A0(0x0001)
	unsigned char                                      bHasPerLODVertexColors : 1;                               // 0x00A0(0x0001)
	unsigned char                                      bAllowCPUAccess : 1;                                      // 0x00A0(0x0001) (Edit)
...
struct FSkeletalMeshSamplingRegionBoneFilter
{
	struct FName                                       BoneName;                                                 // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIncludeOrExclude : 1;                                    // 0x000C(0x0001) (Edit)
...
struct FSkeletalMeshSamplingRegion
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                LODIndex;                                                 // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSupportUniformlyDistributedSampling : 1;                 // 0x0010(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0011(0x0007) MISSED OFFSET
	TArray<struct FSkeletalMeshSamplingRegionMaterialFilter> MaterialFilters;                                          // 0x0018(0x0010) (Edit, ZeroConstructor)
	TArray<struct FSkeletalMeshSamplingRegionBoneFilter> BoneFilters;                                              // 0x0028(0x0010) (Edit, ZeroConstructor)
};
...
struct FRepRootMotionMontage
{
	...
	unsigned char                                      UnknownData02[0x4];                                       // 0x0038(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               bRelativePosition;                                        // 0x0044(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bRelativeRotation;                                        // 0x0045(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FPoseSnapshot
{
	...
	struct FName                                       SnapshotName;                                             // 0x002C(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x002C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               bIsValid;                                                 // 0x0038(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FAnimNotifyEvent : public FAnimLinkableElement
{
	...
	class UAnimNotify*                                 Notify;                                                   // 0x0050(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAnimNotifyState*                            NotifyStateClass;                                         // 0x0058(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	bool                                               bTriggerOnDedicatedServer;                                // 0x00A8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bTriggerOnFollower;                                       // 0x00A9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x2];                                       // 0x00AA(0x0002) MISSED OFFSET
	int                                                TrackIndex;                                               // 0x00AC(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x18];                                      // 0x00B0(0x0018) MISSED OFFSET
};
...
struct FMarkerSyncAnimPosition
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       NextMarkerName;                                           // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              PositionBetweenMarkers;                                   // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FAudioComponentParam
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              FloatParam;                                               // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               BoolParam;                                                // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	int                                                IntParam;                                                 // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	TEnumAsByte<ERichCurveExtrapolation>               PreInfinityExtrap;                                        // 0x0068(0x0001) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ERichCurveExtrapolation>               PostInfinityExtrap;                                       // 0x0069(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x006A(0x0002) MISSED OFFSET
	float                                              defaultValue;                                             // 0x006C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FSoundAttenuationSettings : public FBaseAttenuationSettings
{
	...
	EAirAbsorptionMethod                               AbsorptionMethod;                                         // 0x00B3(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     OcclusionTraceChannel;                                    // 0x00B4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EReverbSendMethod                                  ReverbSendMethod;                                         // 0x00B5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x00B6(0x0002) MISSED OFFSET
	float                                              OmniRadius;                                               // 0x00B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              StereoSpread;                                             // 0x00BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPFRadiusMin;                                             // 0x00C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPFRadiusMax;                                             // 0x00C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FRuntimeFloatCurve                          CustomLowpassAirAbsorptionCurve;                          // 0x00C8(0x0088) (Edit, BlueprintVisible)
	struct FRuntimeFloatCurve                          CustomHighpassAirAbsorptionCurve;                         // 0x0150(0x0088) (Edit, BlueprintVisible)
	float                                              LPFFrequencyAtMin;                                        // 0x01D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPFFrequencyAtMax;                                        // 0x01DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HPFFrequencyAtMin;                                        // 0x01E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HPFFrequencyAtMax;                                        // 0x01E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FocusAzimuth;                                             // 0x01E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NonFocusAzimuth;                                          // 0x01EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FocusDistanceScale;                                       // 0x01F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NonFocusDistanceScale;                                    // 0x01F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FocusPriorityScale;                                       // 0x01F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NonFocusPriorityScale;                                    // 0x01FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FocusVolumeAttenuation;                                   // 0x0200(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NonFocusVolumeAttenuation;                                // 0x0204(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FocusAttackInterpSpeed;                                   // 0x0208(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FocusReleaseInterpSpeed;                                  // 0x020C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              OcclusionLowPassFilterFrequency;                          // 0x0210(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              OcclusionVolumeAttenuation;                               // 0x0214(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              OcclusionInterpolationTime;                               // 0x0218(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ReverbWetLevelMin;                                        // 0x021C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ReverbWetLevelMax;                                        // 0x0220(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ReverbDistanceMin;                                        // 0x0224(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ReverbDistanceMax;                                        // 0x0228(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ManualReverbSendLevel;                                    // 0x022C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FRuntimeFloatCurve                          CustomReverbSendCurve;                                    // 0x0230(0x0088) (Edit, BlueprintVisible)
	struct FSoundAttenuationPluginSettings             PluginSettings;                                           // 0x02B8(0x0030) (Edit, BlueprintVisible)
};
...
struct FNavAgentProperties : public FMovementProperties
{
	...
	unsigned char                                      UnknownData01[0x4];                                       // 0x0014(0x0004) MISSED OFFSET
	struct FSoftClassPath                              PreferredNavData;                                         // 0x0018(0x0020) (Edit, BlueprintVisible, ZeroConstructor)
};
...
struct FPostProcessSettings
{
	...
	unsigned char                                      bOverride_RayTracingAOSamplesPerPixel : 1;                // 0x0010(0x0001) (BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	...
	unsigned char                                      bOverride_DepthOfFieldMaxBokehSize : 1;                   // 0x0017(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldNearBlurSize : 1;                   // 0x0017(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldFarBlurSize : 1;                    // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldMethod : 1;                         // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_MobileHQGaussian : 1;                           // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldBokehShape : 1;                     // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldOcclusion : 1;                      // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldColorThreshold : 1;                 // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldSizeThreshold : 1;                  // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldSkyFocusDistance : 1;               // 0x0018(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_DepthOfFieldVignetteSize : 1;                   // 0x0019(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_MotionBlurAmount : 1;                           // 0x0019(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_MotionBlurMax : 1;                              // 0x0019(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_MotionBlurPerObjectSize : 1;                    // 0x0019(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bOverride_ScreenSpaceReflectionRoughnessScale : 1;        // 0x001A(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData02[0x1];                                       // 0x001B(0x0001) MISSED OFFSET
	unsigned char                                      bOverride_ReflectionsType : 1;                            // 0x001C(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_RayTracingReflectionsMaxRoughness : 1;          // 0x001C(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_RayTracingReflectionsMaxBounces : 1;            // 0x001C(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_RayTracingReflectionsSamplesPerPixel : 1;       // 0x001C(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_RayTracingReflectionsShadows : 1;               // 0x001C(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_TranslucencyType : 1;                           // 0x001C(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_RayTracingTranslucencyMaxRoughness : 1;         // 0x001C(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_RayTracingTranslucencyRefractionRays : 1;       // 0x001C(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_RayTracingTranslucencySamplesPerPixel : 1;      // 0x001D(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_RayTracingTranslucencyShadows : 1;              // 0x001D(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_RayTracingTranslucencyRefraction : 1;           // 0x001D(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_RayTracingGI : 1;                               // 0x001D(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_RayTracingGIMaxBounces : 1;                     // 0x001D(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_RayTracingGISamplesPerPixel : 1;                // 0x001D(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_PathTracingMaxBounces : 1;                      // 0x001D(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_PathTracingSamplesPerPixel : 1;                 // 0x001D(0x0001) (BlueprintVisible)
	...
	TEnumAsByte<EDepthOfFieldMethod>                   DepthOfFieldMethod;                                       // 0x0023(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	int                                                RayTracingAOSamplesPerPixel;                              // 0x0420(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                IndirectLightingColor;                                    // 0x0424(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              IndirectLightingIntensity;                                // 0x0434(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      RayTracingGI : 1;                                         // 0x0438(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData06[0x3];                                       // 0x0439(0x0003) MISSED OFFSET
	int                                                RayTracingGIMaxBounces;                                   // 0x043C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                RayTracingGISamplesPerPixel;                              // 0x0440(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	float                                              DepthOfFieldSensorWidth;                                  // 0x0450(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFocalDistance;                                // 0x0454(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldDepthBlurAmount;                              // 0x0458(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldDepthBlurRadius;                              // 0x045C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFocalRegion;                                  // 0x0460(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldNearTransitionRegion;                         // 0x0464(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFarTransitionRegion;                          // 0x0468(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldScale;                                        // 0x046C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldMaxBokehSize;                                 // 0x0470(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldNearBlurSize;                                 // 0x0474(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFarBlurSize;                                  // 0x0478(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldOcclusion;                                    // 0x047C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UTexture*                                    DepthOfFieldBokehShape;                                   // 0x0480(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldColorThreshold;                               // 0x0488(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldSizeThreshold;                                // 0x048C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldSkyFocusDistance;                             // 0x0490(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	float                                              LPVIntensity;                                             // 0x04A4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVVplInjectionBias;                                      // 0x04A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSize;                                                  // 0x04AC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSecondaryOcclusionIntensity;                           // 0x04B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSecondaryBounceIntensity;                              // 0x04B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVGeometryVolumeBias;                                    // 0x04B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVEmissiveInjectionIntensity;                            // 0x04BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDirectionalOcclusionIntensity;                         // 0x04C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDirectionalOcclusionRadius;                            // 0x04C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDiffuseOcclusionExponent;                              // 0x04C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSpecularOcclusionExponent;                             // 0x04CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDiffuseOcclusionIntensity;                             // 0x04D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSpecularOcclusionIntensity;                            // 0x04D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EReflectionsType                                   ReflectionsType;                                          // 0x04D8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x3];                                       // 0x04D9(0x0003) MISSED OFFSET
	float                                              ScreenSpaceReflectionIntensity;                           // 0x04DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScreenSpaceReflectionQuality;                             // 0x04E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScreenSpaceReflectionMaxRoughness;                        // 0x04E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RayTracingReflectionsMaxRoughness;                        // 0x04E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                RayTracingReflectionsMaxBounces;                          // 0x04EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                RayTracingReflectionsSamplesPerPixel;                     // 0x04F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EReflectedAndRefractedRayTracedShadows             RayTracingReflectionsShadows;                             // 0x04F4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	ETranslucencyType                                  TranslucencyType;                                         // 0x04F5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x2];                                       // 0x04F6(0x0002) MISSED OFFSET
	float                                              RayTracingTranslucencyMaxRoughness;                       // 0x04F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                RayTracingTranslucencyRefractionRays;                     // 0x04FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                RayTracingTranslucencySamplesPerPixel;                    // 0x0500(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EReflectedAndRefractedRayTracedShadows             RayTracingTranslucencyShadows;                            // 0x0504(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      RayTracingTranslucencyRefraction : 1;                     // 0x0505(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData09[0x2];                                       // 0x0506(0x0002) MISSED OFFSET
	int                                                PathTracingMaxBounces;                                    // 0x0508(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                PathTracingSamplesPerPixel;                               // 0x050C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVFadeRange;                                             // 0x0510(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDirectionalOcclusionFadeRange;                         // 0x0514(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScreenPercentage;                                         // 0x0518(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x4];                                       // 0x051C(0x0004) MISSED OFFSET
	struct FWeightedBlendables                         WeightedBlendables;                                       // 0x0520(0x0010) (Edit, BlueprintVisible)
};
...
struct FFindFloorResult
{
	...
	struct FHitResult                                  HitResult;                                                // 0x000C(0x0090) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnTemplate, EditConst, IsPlainOldData)
};
...
struct FParticleSysParam
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<EParticleSysParamType>                 ParamType;                                                // 0x000C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	float                                              Scalar;                                                   // 0x0010(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Scalar_Low;                                               // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Vector;                                                   // 0x0018(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Vector_Low;                                               // 0x0024(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FColor                                      Color;                                                    // 0x0030(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
	class AActor*                                      Actor;                                                    // 0x0038(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          Material;                                                 // 0x0040(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x48];                                      // 0x0048(0x0048) MISSED OFFSET
};
...
struct FUpdateLevelVisibilityLevelInfo
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsVisible : 1;                                           // 0x000C(0x0001)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
};
...
struct FLatentActionInfo
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x0014(0x0004) MISSED OFFSET
	class UObject*                                     CallbackTarget;                                           // 0x0018(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
struct FUpdateLevelStreamingLevelStatus
{
	...
	unsigned char                                      bNewShouldBeLoaded : 1;                                   // 0x0010(0x0001)
	unsigned char                                      bNewShouldBeVisible : 1;                                  // 0x0010(0x0001)
	unsigned char                                      bNewShouldBlockOnLoad : 1;                                // 0x0010(0x0001)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
};
...
struct FForceFeedbackParameters
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               bLooping;                                                 // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreTimeDilation;                                      // 0x000D(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPlayWhilePaused;                                         // 0x000E(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FGameNameRedirect
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       NewGameName;                                              // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
struct FClassRedirect
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       OldClassName;                                             // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       NewClassName;                                             // 0x0018(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0018(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       OldSubobjName;                                            // 0x0024(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0024(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       NewSubobjName;                                            // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0030(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       NewClassClass;                                            // 0x003C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x003C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       NewClassPackage;                                          // 0x0048(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0048(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               InstanceOnly;                                             // 0x0054(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FStructRedirect
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       NewStructName;                                            // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
struct FNetDriverDefinition
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       DriverClassName;                                          // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       DriverClassNameFallback;                                  // 0x0018(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0018(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
// ScriptStruct Engine.MaterialConfig
// 0x0010
struct FMaterialConfig
{
	TArray<class UMaterialInterface*>                  MaterialPerSection;                                       // 0x0000(0x0010) (ZeroConstructor)
};

// ScriptStruct Engine.IndexList
// 0x0010
struct FIndexList
{
	TArray<int>                                        Indexes;                                                  // 0x0000(0x0010) (ZeroConstructor)
};
...
struct FMaterialParameterInfo
{
	struct FName                                       Name;                                                     // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<EMaterialParameterAssociation>         Association;                                              // 0x000C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	int                                                Index;                                                    // 0x0010(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
{
	struct FMaterialParameterInfo                      ParameterInfo;                                            // 0x0000(0x0014) (Edit, BlueprintVisible)
	float                                              ParameterValue;                                           // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	struct FMaterialParameterInfo                      ParameterInfo;                                            // 0x0000(0x0014) (Edit, BlueprintVisible)
	struct FLinearColor                                ParameterValue;                                           // 0x0014(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGuid                                       ExpressionGUID;                                           // 0x0024(0x0010) (ZeroConstructor, IsPlainOldData)
};
...
struct FTextureParameterValue
{
	...
	class UTexture*                                    ParameterValue;                                           // 0x0018(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FFontParameterValue
{
	struct FMaterialParameterInfo                      ParameterInfo;                                            // 0x0000(0x0014) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0014(0x0004) MISSED OFFSET
	class UFont*                                       FontValue;                                                // 0x0018(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                FontPage;                                                 // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGuid                                       ExpressionGUID;                                           // 0x0024(0x0010) (ZeroConstructor, IsPlainOldData)
...
struct FMaterialInstanceBasePropertyOverrides
{
	...
	unsigned char                                      bOverride_CastMaskedMaterialShadow : 1;                   // 0x0000(0x0001) (Edit)
	...
	unsigned char                                      CastMaskedMaterialShadow : 1;                             // 0x0001(0x0001) (Edit)
...
{
	struct FMaterialParameterInfo                      ParameterInfo;                                            // 0x0000(0x0014)
	bool                                               value;                                                    // 0x0014(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bOverride;                                                // 0x0015(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	struct FMaterialParameterInfo                      ParameterInfo;                                            // 0x0000(0x0014)
	bool                                               R;                                                        // 0x0014(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               G;                                                        // 0x0015(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               B;                                                        // 0x0016(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               A;                                                        // 0x0017(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bOverride;                                                // 0x0018(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FStaticTerrainLayerWeightParameter
{
	...
	struct FGuid                                       ExpressionGUID;                                           // 0x0018(0x0010) (ZeroConstructor, IsPlainOldData)
	int                                                WeightmapIndex;                                           // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bWeightBasedBlend;                                        // 0x002C(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FStaticMaterialLayersParameter
{
	struct FMaterialParameterInfo                      ParameterInfo;                                            // 0x0000(0x0014)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0014(0x0004) MISSED OFFSET
	struct FMaterialLayersFunctions                    value;                                                    // 0x0018(0x0040)
	bool                                               bOverride;                                                // 0x0058(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0059(0x0003) MISSED OFFSET
	struct FGuid                                       ExpressionGUID;                                           // 0x005C(0x0010) (ZeroConstructor, IsPlainOldData)
...
struct FBlueprintComponentChangedPropertyInfo
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                ArrayIndex;                                               // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FBlueprintCookedComponentInstancingData
{
	...
	unsigned char                                      UnknownData01[0x40];                                      // 0x0018(0x0040) MISSED OFFSET
};
...
{
	struct FBoneReference                              BoneReference;                                            // 0x0000(0x0014) (Edit)
	float                                              InterpolationSpeedPerSec;                                 // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FBakedAnimationState
{
	...
	bool                                               bAlwaysResetOnEntry;                                      // 0x0048(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	int                                                previousState;                                            // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                NextState;                                                // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CrossfadeDuration;                                        // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	EAlphaBlendOption                                  BlendMode;                                                // 0x0024(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FBakedAnimationStateMachine
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                InitialState;                                             // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FExposedValueCopyRecord
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       SourceSubPropertyName;                                    // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                SourceArrayIndex;                                         // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bInstanceIsTarget;                                        // 0x001C(0x0001) (ZeroConstructor, IsPlainOldData)
	EPostCopyOperation                                 PostCopyOperation;                                        // 0x001D(0x0001) (ZeroConstructor, IsPlainOldData)
	ECopyType                                          CopyType;                                                 // 0x001E(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	...
	class UProperty*                                   CachedSourceProperty;                                     // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
	class UProperty*                                   CachedSourceStructSubProperty;                            // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
struct FExposedValueHandler
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	TArray<struct FExposedValueCopyRecord>             CopyRecords;                                              // 0x0010(0x0010) (ZeroConstructor)
	class UFunction*                                   Function;                                                 // 0x0020(0x0008) (ZeroConstructor, IsPlainOldData)
	class UStructProperty*                             ValueHandlerNodeProperty;                                 // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
...
struct FAnimCurveBase
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FSmartName                                  Name;                                                     // 0x000C(0x0010)
	int                                                CurveTypeFlags;                                           // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	struct FRichCurve                                  FloatCurve;                                               // 0x0020(0x0080)
};
...
struct FAnimSyncMarker
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              Time;                                                     // 0x000C(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
};
...
struct FCompositeSection : public FAnimLinkableElement
{
	...
	float                                              StartTime;                                                // 0x003C(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	...
	TArray<class UAnimMetaData*>                       MetaData;                                                 // 0x0050(0x0010) (Edit, ExportObject, ZeroConstructor)
};
...
struct FSlotAnimationTrack
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	struct FAnimTrack                                  AnimTrack;                                                // 0x0010(0x0010) (Edit)
};
...
struct FBranchingPoint : public FAnimLinkableElement
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0030(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              DisplayTime;                                              // 0x003C(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              TriggerTimeOffset;                                        // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FPrimaryAssetTypeInfo
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	unsigned char                                      UnknownData02[0x30];                                      // 0x000C(0x0030) UNKNOWN PROPERTY: SoftClassProperty Engine.PrimaryAssetTypeInfo.AssetBaseClass
	class UClass*                                      AssetBaseClassLoaded;                                     // 0x0040(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bHasBlueprintClasses;                                     // 0x0048(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsEditorOnly;                                            // 0x0049(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x6];                                       // 0x004A(0x0006) MISSED OFFSET
	TArray<struct FDirectoryPath>                      Directories;                                              // 0x0050(0x0010) (Edit, ZeroConstructor)
	TArray<struct FSoftObjectPath>                     SpecificAssets;                                           // 0x0060(0x0010) (Edit, ZeroConstructor)
	struct FPrimaryAssetRules                          Rules;                                                    // 0x0070(0x0010) (Edit)
	TArray<struct FString>                             AssetScanPaths;                                           // 0x0080(0x0010) (ZeroConstructor, Transient)
	bool                                               bIsDynamicAsset;                                          // 0x0090(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0091(0x0003) MISSED OFFSET
	int                                                NumberOfAssets;                                           // 0x0094(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
};
...
{
	struct FPrimaryAssetId                             PrimaryAssetId;                                           // 0x0000(0x0018) (Edit, ZeroConstructor)
	struct FPrimaryAssetRules                          Rules;                                                    // 0x0018(0x0010) (Edit)
};
...
{
	struct FPrimaryAssetType                           PrimaryAssetType;                                         // 0x0000(0x000C) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	struct FDirectoryPath                              FilterDirectory;                                          // 0x0010(0x0010) (Edit)
	struct FString                                     FilterString;                                             // 0x0020(0x0010) (Edit, ZeroConstructor)
...
{
	struct FSoftObjectPath                             PerformanceTestmap;                                       // 0x0000(0x0020) (Edit, ZeroConstructor, Config)
	int                                                TestTimer;                                                // 0x0020(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0024(0x0004) MISSED OFFSET
};
...
// ScriptStruct Engine.PerMeshInstancingData
// 0x00A0
struct FPerMeshInstancingData
{
	TMap<uint32_t, class UInstancedStaticMeshComponent*> HashToInstancedMeshes;                                    // 0x0000(0x0050) (ExportObject, ZeroConstructor, Transient)
...
struct FBoneNode
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                ParentIndex;                                              // 0x000C(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	TEnumAsByte<EBoneTranslationRetargetingMode>       TranslationRetargetingMode;                               // 0x0010(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
};
...
struct FVirtualBone
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       TargetBoneName;                                           // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       VirtualBoneName;                                          // 0x0018(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0018(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
struct FAnimSlotGroup
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	TArray<struct FName>                               SlotNames;                                                // 0x0010(0x0010) (ZeroConstructor)
};
...
{
	struct FBoneReference                              BoneReference;                                            // 0x0000(0x0014) (Edit)
	float                                              BlendScale;                                               // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FBranchFilter
{
	struct FName                                       BoneName;                                                 // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                BlendDepth;                                               // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FCollisionResponseTemplate
{
	struct FName                                       Name;                                                     // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<ECollisionEnabled>                     CollisionEnabled;                                         // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	struct FName                                       ObjectTypeName;                                           // 0x0010(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x000D(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData03[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	TArray<struct FResponseChannel>                    CustomResponses;                                          // 0x0020(0x0010) (ZeroConstructor)
	struct FString                                     HelpMessage;                                              // 0x0030(0x0010) (ZeroConstructor)
	bool                                               bCanModify;                                               // 0x0040(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x27];                                      // 0x0041(0x0027) MISSED OFFSET
};
...
struct FCustomProfile
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	TArray<struct FResponseChannel>                    CustomResponses;                                          // 0x0010(0x0010) (ZeroConstructor)
};
...
struct FRedirector
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       NewName;                                                  // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
struct FBlueprintComponentDelegateBinding
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       DelegatePropertyName;                                     // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UnknownData00[0x10];                                      // 0x0000(0x0010) MISSED OFFSET
	class UObject*                                     Archetype;                                                // 0x0010(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x18];                                      // 0x0018(0x0018) MISSED OFFSET
	class ULevel*                                      Level;                                                    // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x60];                                      // 0x0038(0x0060) MISSED OFFSET
	TArray<class UObject*>                             ObjReferences;                                            // 0x0098(0x0010) (ZeroConstructor)
};
...
struct FTextureLODGroup
{
	...
	unsigned char                                      UnknownData04[0x4];                                       // 0x003C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       MipFilter;                                                // 0x004C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x004C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
struct FEdGraphTerminalType
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       TerminalSubCategory;                                      // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FEdGraphPinType
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       PinSubCategory;                                           // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TWeakObjectPtr<class UObject>                      PinSubCategoryObject;                                     // 0x0018(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FSimpleMemberReference                      PinSubCategoryMemberReference;                            // 0x0020(0x0028)
	struct FEdGraphTerminalType                        PinValueType;                                             // 0x0048(0x0024)
	EPinContainerType                                  ContainerType;                                            // 0x006C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bIsArray : 1;                                             // 0x006D(0x0001) (Deprecated)
	unsigned char                                      bIsReference : 1;                                         // 0x006D(0x0001)
	unsigned char                                      bIsConst : 1;                                             // 0x006D(0x0001)
	unsigned char                                      bIsWeakPointer : 1;                                       // 0x006D(0x0001)
...
// ScriptStruct Engine.HeightFogGradientEntry
// 0x0014
struct FHeightFogGradientEntry
{
	struct FLinearColor                                Colour;                                                   // 0x0000(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              GradientHeight;                                           // 0x0010(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
};
...
struct FComponentKey
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FGuid                                       AssociatedGuid;                                           // 0x0014(0x0010) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0024(0x0004) MISSED OFFSET
};
...
struct FComponentOverrideRecord
{
	...
	struct FComponentKey                               ComponentKey;                                             // 0x0010(0x0028)
	struct FBlueprintCookedComponentInstancingData     CookedComponentInstancingData;                            // 0x0038(0x0058)
};
...
struct FBlueprintInputActionDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData01[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	struct FName                                       FunctionNameToBind;                                       // 0x0014(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0011(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
struct FBlueprintInputAxisDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData01[0x4];                                       // 0x0010(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
struct FBlueprintInputKeyDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData02[0x4];                                       // 0x0031(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
struct FInputAxisConfigEntry
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FInputAxisProperties                        AxisProperties;                                           // 0x000C(0x0010) (Edit)
};
...
{
	struct FName                                       ActionName;                                               // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bShift : 1;                                               // 0x000C(0x0001) (Edit, BlueprintVisible, SaveGame)
	unsigned char                                      bCtrl : 1;                                                // 0x000C(0x0001) (Edit, BlueprintVisible, SaveGame)
	unsigned char                                      bAlt : 1;                                                 // 0x000C(0x0001) (Edit, BlueprintVisible, SaveGame)
	unsigned char                                      bCmd : 1;                                                 // 0x000C(0x0001) (Edit, BlueprintVisible, SaveGame)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	struct FKey                                        Key;                                                      // 0x0010(0x0020) (Edit, BlueprintVisible, SaveGame)
};
...
{
	struct FName                                       AxisName;                                                 // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              Scale;                                                    // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData)
	struct FKey                                        Key;                                                      // 0x0010(0x0020) (Edit, BlueprintVisible, SaveGame)
};
...
struct FBlueprintInputTouchDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData01[0x4];                                       // 0x0005(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
struct FDirectorTrackCut
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                ShotNumber;                                               // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FCustomInput
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FExpressionInput                            Input;                                                    // 0x000C(0x0010)
...
struct FCollectionParameterBase
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FGuid                                       ID;                                                       // 0x000C(0x0010) (ZeroConstructor, IsPlainOldData)
};
...
{
	struct FLinearColor                                defaultValue;                                             // 0x001C(0x0010) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FInterpGroupActorInfo
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	TArray<class AActor*>                              Actors;                                                   // 0x0010(0x0010) (Edit, ZeroConstructor)
};
...
struct FParticleRandomSeedInfo
{
	struct FName                                       ParameterName;                                            // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bGetSeedFromInstance : 1;                                 // 0x000C(0x0001) (Edit)
	unsigned char                                      bInstanceSeedIsIndex : 1;                                 // 0x000C(0x0001) (Edit)
	unsigned char                                      bResetSeedOnEmitterLooping : 1;                           // 0x000C(0x0001) (Edit)
	unsigned char                                      bRandomlySelectSeedArray : 1;                             // 0x000C(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
...
struct FParticleEvent_GenerateInfo
{
	...
	unsigned char                                      UnknownData02[0x4];                                       // 0x000D(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData03[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	TArray<class UParticleModuleEventSendToGame*>      ParticleModuleEventsToSendToGame;                         // 0x0020(0x0010) (Edit, ExportObject, ZeroConstructor)
};
...
struct FLocationBoneSocketInfo
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FVector                                     Offset;                                                   // 0x000C(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FEmitterDynamicParameter
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bUseEmitterTime : 1;                                      // 0x000C(0x0001) (Edit)
	unsigned char                                      bSpawnTimeOnly : 1;                                       // 0x000C(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	TEnumAsByte<EEmitterDynamicParameterValue>         ValueMethod;                                              // 0x0010(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	unsigned char                                      bScaleVelocityByParamValue : 1;                           // 0x0014(0x0001) (Edit)
...
struct FPhysicalAnimationData
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsLocalSimulation : 1;                                   // 0x000C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	float                                              OrientationStrength;                                      // 0x0010(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AngularVelocityStrength;                                  // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PositionStrength;                                         // 0x0018(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              VelocityStrength;                                         // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxLinearForce;                                           // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxAngularForce;                                          // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FPhysicalAnimationProfile
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FPhysicalAnimationData                      PhysicalAnimationData;                                    // 0x000C(0x0028) (Edit)
};
...
struct FConstraintInstance
{
	...
	unsigned char                                      UnknownData03[0x4];                                       // 0x0030(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FVector                                     Pos1;                                                     // 0x003C(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     PriAxis1;                                                 // 0x0048(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     SecAxis1;                                                 // 0x0054(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     Pos2;                                                     // 0x0060(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     PriAxis2;                                                 // 0x006C(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     SecAxis2;                                                 // 0x0078(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FRotator                                    AngularRotationOffset;                                    // 0x0084(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bScaleLinearLimits : 1;                                   // 0x0090(0x0001) (Edit)
	unsigned char                                      UnknownData04[0x7];                                       // 0x0091(0x0007) MISSED OFFSET
	struct FConstraintProfileProperties                ProfileInstance;                                          // 0x0098(0x0104) (Edit)
	unsigned char                                      UnknownData05[0x2C];                                      // 0x019C(0x002C) MISSED OFFSET
};
...
struct FKeyBind
{
	...
	struct FString                                     Command;                                                  // 0x0020(0x0010) (ZeroConstructor, Config)
	...
	unsigned char                                      bDisabled : 1;                                            // 0x0031(0x0001) (Transient)
...
{
	unsigned char                                      UnknownData00[0x30];                                      // 0x0000(0x0030) UNKNOWN PROPERTY: SoftObjectProperty Engine.PreviewMeshCollectionEntry.SkeletalMesh
};
...
struct FTransformBase
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	struct FTransformBaseConstraint                    Constraints[0x2];                                         // 0x0010(0x0010) (Edit)
};
...
struct FNode
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       ParentName;                                               // 0x000C(0x0008) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData02[0x8];                                       // 0x0018(0x0008) MISSED OFFSET
	struct FTransform                                  Transform;                                                // 0x0020(0x0030) (IsPlainOldData)
	struct FString                                     DisplayName;                                              // 0x0050(0x0010) (Edit, ZeroConstructor)
	bool                                               bAdvanced;                                                // 0x0060(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FBPVariableMetaDataEntry
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	struct FString                                     DataValue;                                                // 0x0010(0x0010) (Edit, ZeroConstructor)
};
...
struct FModulatorContinuousParams
{
	struct FName                                       ParameterName;                                            // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              Default;                                                  // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinInput;                                                 // 0x0010(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxInput;                                                 // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinOutput;                                                // 0x0018(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxOutput;                                                // 0x001C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EModulationParamMode>                  ParamMode;                                                // 0x0020(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FStaticMaterial
{
	...
	struct FName                                       MaterialSlotName;                                         // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       ImportedMaterialSlotName;                                 // 0x0014(0x0008) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0014(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FMeshUVChannelInfo                          UVChannelData;                                            // 0x0020(0x0014) (Edit, BlueprintVisible, BlueprintReadOnly, EditConst)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
};
...
struct FTimelineVectorTrack
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       TrackName;                                                // 0x001C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x001C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       VectorPropertyName;                                       // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData03[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
	class UStructProperty*                             VectorProperty;                                           // 0x0038(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData04[0x10];                                      // 0x0040(0x0010) MISSED OFFSET
};
...
struct FTimelineFloatTrack
{
	...
	struct FName                                       TrackName;                                                // 0x001C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x001C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       FloatPropertyName;                                        // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData03[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
	class UFloatProperty*                              FloatProperty;                                            // 0x0038(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData04[0x10];                                      // 0x0040(0x0010) MISSED OFFSET
};
...
struct FTimelineLinearColorTrack
{
	...
	struct FName                                       TrackName;                                                // 0x001C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x001C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       LinearColorPropertyName;                                  // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData03[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
	class UStructProperty*                             LinearColorProperty;                                      // 0x0038(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData04[0x10];                                      // 0x0040(0x0010) MISSED OFFSET
};
...
struct FTimeline
{
	...
	struct FScriptDelegate                             TimelineFinishedFunc;                                     // 0x0064(0x0010) (ZeroConstructor, InstancedReference, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0064(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TWeakObjectPtr<class UObject>                      PropertySetObject;                                        // 0x0078(0x0008) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	struct FName                                       DirectionPropertyName;                                    // 0x0080(0x0008) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0080(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData04[0x14];                                      // 0x008C(0x0014) MISSED OFFSET
	class UProperty*                                   DirectionProperty;                                        // 0x00A0(0x0008) (ZeroConstructor, Transient, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};
...
struct FTTTrackBase
{
	...
	unsigned char                                      UnknownData01[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               bIsExternalCurve;                                         // 0x0014(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FTTEventTrack : public FTTTrackBase
{
	...
	unsigned char                                      UnknownData01[0x4];                                       // 0x0024(0x0004) MISSED OFFSET
	class UCurveFloat*                                 CurveKeys;                                                // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
{
	class UCurveFloat*                                 CurveFloat;                                               // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
{
	class UCurveVector*                                CurveVector;                                              // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
{
	class UCurveLinearColor*                           CurveLinearColor;                                         // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
struct FTouchInputControl
{
	...
	struct FVector2D                                   BackgroundSize;                                           // 0x0020(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   ThumbSize;                                                // 0x0028(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   InteractionSize;                                          // 0x0030(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   InputScale;                                               // 0x0038(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FKey                                        MainInputKey;                                             // 0x0040(0x0020) (Edit)
	struct FKey                                        AltInputKey;                                              // 0x0060(0x0020) (Edit)
	bool                                               bPreventRecenter;                                         // 0x0080(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIndependentAxes;                                         // 0x0081(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bManualScaling;                                           // 0x0082(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FHardwareCursorReference
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FVector2D                                   HotSpot;                                                  // 0x000C(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FMaterialProxySettings
{
	...
	unsigned char                                      bAmbientOcclusionMap : 1;                                 // 0x0027(0x0001) (Edit, BlueprintVisible)
	struct FIntPoint                                   DiffuseTextureSize;                                       // 0x0028(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   NormalTextureSize;                                        // 0x0030(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   MetallicTextureSize;                                      // 0x0038(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   RoughnessTextureSize;                                     // 0x0040(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   SpecularTextureSize;                                      // 0x0048(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   EmissiveTextureSize;                                      // 0x0050(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   OpacityTextureSize;                                       // 0x0058(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   OpacityMaskTextureSize;                                   // 0x0060(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   AmbientOcclusionTextureSize;                              // 0x0068(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FMeshProxySettings
{
	...
	struct FMaterialProxySettings                      MaterialSettings;                                         // 0x0008(0x0070) (Edit, BlueprintVisible)
	float                                              MergeDistance;                                            // 0x0078(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FColor                                      UnresolvedGeometryColor;                                  // 0x007C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxRayCastDist;                                           // 0x0080(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HardAngleThreshold;                                       // 0x0084(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                LightMapResolution;                                       // 0x0088(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EProxyNormalComputationMethod>         NormalCalculationMethod;                                  // 0x008C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ELandscapeCullingPrecision>            LandscapeCullingPrecision;                                // 0x008D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCalculateCorrectLODModel : 1;                            // 0x008E(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverrideVoxelSize : 1;                                   // 0x008E(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverrideTransferDistance : 1;                            // 0x008E(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bUseHardAngleThreshold : 1;                               // 0x008E(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bComputeLightMapResolution : 1;                           // 0x008E(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bRecalculateNormals : 1;                                  // 0x008E(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bUseLandscapeCulling : 1;                                 // 0x008E(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bAllowAdjacency : 1;                                      // 0x008E(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bAllowDistanceField : 1;                                  // 0x008F(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bReuseMeshLightmapUVs : 1;                                // 0x008F(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bCreateCollision : 1;                                     // 0x008F(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bAllowVertexColors : 1;                                   // 0x008F(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bGenerateLightmapUVs : 1;                                 // 0x008F(0x0001) (Edit, BlueprintVisible)
};
...
struct FMeshMergingSettings
{
	...
	struct FMaterialProxySettings                      MaterialSettings;                                         // 0x000C(0x0070) (Edit, BlueprintVisible)
	int                                                GutterSize;                                               // 0x007C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                SpecificLOD;                                              // 0x0080(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EMeshLODSelectionType                              LODSelectionType;                                         // 0x0084(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bGenerateLightMapUV : 1;                                  // 0x0085(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bComputedLightMapResolution : 1;                          // 0x0085(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bPivotPointAtZero : 1;                                    // 0x0085(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bMergePhysicsData : 1;                                    // 0x0085(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bMergeMaterials : 1;                                      // 0x0085(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bBakeVertexDataToMesh : 1;                                // 0x0085(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bUseVertexDataForBakingMaterial : 1;                      // 0x0085(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bUseTextureBinning : 1;                                   // 0x0085(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bReuseMeshLightmapUVs : 1;                                // 0x0086(0x0001) (Edit)
	unsigned char                                      bMergeEquivalentMaterials : 1;                            // 0x0086(0x0001) (Edit)
	unsigned char                                      bUseLandscapeCulling : 1;                                 // 0x0086(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bIncludeImposters : 1;                                    // 0x0086(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bAllowDistanceField : 1;                                  // 0x0086(0x0001) (Edit)
...
struct FHierarchicalSimplification
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
	struct FMeshProxySettings                          ProxySetting;                                             // 0x000C(0x0090) (Edit)
	struct FMeshMergingSettings                        MergeSetting;                                             // 0x009C(0x0088) (Edit)
	float                                              DesiredBoundRadius;                                       // 0x0124(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DesiredFillingPercentage;                                 // 0x0128(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MinNumberOfActorsToBuild;                                 // 0x012C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FPlatformInterfaceData
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<EPlatformInterfaceDataType>            Type;                                                     // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	int                                                IntValue;                                                 // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              FloatValue;                                               // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
	struct FRichCurve                                  FloatCurves[0x3];                                         // 0x0020(0x0080)
};

// ScriptStruct Engine.TransformCurve
// 0x04E0 (0x0500 - 0x0020)
struct FTransformCurve : public FAnimCurveBase
{
	struct FVectorCurve                                TranslationCurve;                                         // 0x0020(0x01A0)
	struct FVectorCurve                                RotationCurve;                                            // 0x01C0(0x01A0)
	struct FVectorCurve                                ScaleCurve;                                               // 0x0360(0x01A0)
};
...
struct FAnimMontageInstance
{
	...
	int                                                DisableRootMotionCount;                                   // 0x0180(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData05[0x34];                                      // 0x0184(0x0034) MISSED OFFSET
};
...
struct FAnimNode_SaveCachedPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0020(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x8C];                                      // 0x002C(0x008C) MISSED OFFSET
};
...
{
	struct FPoseLink                                   InPose;                                                   // 0x0010(0x0010)
	class UClass*                                      InstanceClass;                                            // 0x0020(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       Tag;                                                      // 0x0028(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
	TArray<struct FName>                               SourcePropertyNames;                                      // 0x0038(0x0010) (ZeroConstructor)
	TArray<struct FName>                               DestPropertyNames;                                        // 0x0048(0x0010) (ZeroConstructor)
	class UAnimInstance*                               InstanceToRun;                                            // 0x0058(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<class UProperty*>                           InstanceProperties;                                       // 0x0060(0x0010) (ZeroConstructor, Transient)
	TArray<class UProperty*>                           SubInstanceProperties;                                    // 0x0070(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData02[0x20];                                      // 0x0080(0x0020) MISSED OFFSET
};
...
struct FCurveTrack
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	TArray<float>                                      CurveWeights;                                             // 0x0010(0x0010) (ZeroConstructor)
};
...
{
	unsigned char                                      UnknownData00[0x150];                                     // 0x0690(0x0150) MISSED OFFSET
};
...
struct FAnimationTransitionRule
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               TransitionReturnVal;                                      // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	int                                                TransitionIndex;                                          // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	TArray<struct FAnimationTransitionRule>            Transitions;                                              // 0x0010(0x0010) (ZeroConstructor)
	int                                                StateRootNodeIndex;                                       // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                StartNotify;                                              // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                EndNotify;                                                // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FullyBlendedNotify;                                       // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FAnimNotifyTrack
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FLinearColor                                TrackColor;                                               // 0x000C(0x0010) (ZeroConstructor, IsPlainOldData)
...
{
	struct FSoftObjectPath                             EditedObjectPath;                                         // 0x0000(0x0020) (ZeroConstructor)
	struct FVector2D                                   SavedViewOffset;                                          // 0x0020(0x0008) (ZeroConstructor, IsPlainOldData)
...
struct FBPVariableDescription
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FGuid                                       VarGuid;                                                  // 0x000C(0x0010) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	struct FEdGraphPinType                             VarType;                                                  // 0x0020(0x0070) (Edit)
	struct FString                                     FriendlyName;                                             // 0x0090(0x0010) (Edit, ZeroConstructor)
	struct FText                                       Category;                                                 // 0x00A0(0x0018) (Edit)
	uint64_t                                           PropertyFlags;                                            // 0x00B8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FName                                       RepNotifyFunc;                                            // 0x00C0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x00C0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<ELifetimeCondition>                    ReplicationCondition;                                     // 0x00CC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	struct FString                                     defaultValue;                                             // 0x00E0(0x0010) (Edit, ZeroConstructor)
};
...
struct FCompilerNativizationOptions
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               ServerOnlyPlatform;                                       // 0x000C(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               ClientOnlyPlatform;                                       // 0x000D(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bExcludeMonolithicHeaders;                                // 0x000E(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x000F(0x0001) MISSED OFFSET
...
struct FCachedAnimTransitionData
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       FromStateName;                                            // 0x000C(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       ToStateName;                                              // 0x0018(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0018(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData03[0xC];                                       // 0x0024(0x000C) MISSED OFFSET
};
...
struct FCachedAnimRelevancyData
{
	struct FName                                       StateMachineName;                                         // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       StateName;                                                // 0x000C(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData02[0xC];                                       // 0x0018(0x000C) MISSED OFFSET
};
...
struct FChildActorAttachedActorInfo
{
	...
	struct FTransform                                  RelativeTransform;                                        // 0x0020(0x0030) (IsPlainOldData)
};
...
struct FChildActorComponentInstanceData : public FSceneComponentInstanceData
{
	...
	TArray<struct FChildActorAttachedActorInfo>        AttachedActors;                                           // 0x00B8(0x0010) (ZeroConstructor)
...
struct FDataTableCategoryHandle
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       RowContents;                                              // 0x0014(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0014(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
struct FLevelStreamingStatus
{
	struct FName                                       PackageName;                                              // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bShouldBeLoaded : 1;                                      // 0x000C(0x0001)
	unsigned char                                      bShouldBeVisible : 1;                                     // 0x000C(0x0001)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	uint32_t                                           LODIndex;                                                 // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FWorldContext
{
	...
	struct FURL                                        LastURL;                                                  // 0x00D8(0x0068)
	struct FURL                                        LastRemoteURL;                                            // 0x0140(0x0068)
	class UPendingNetGame*                             PendingNetGame;                                           // 0x01A8(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FFullyLoadedPackagesInfo>            PackagesToFullyLoad;                                      // 0x01B0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x10];                                      // 0x01C0(0x0010) MISSED OFFSET
	TArray<class ULevel*>                              LoadedLevelsForPendingMapChange;                          // 0x01D0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x18];                                      // 0x01E0(0x0018) MISSED OFFSET
	TArray<class UObjectReferencer*>                   ObjectReferencers;                                        // 0x01F8(0x0010) (ZeroConstructor)
	TArray<struct FLevelStreamingStatus>               PendingLevelStreamingStatusUpdates;                       // 0x0208(0x0010) (ZeroConstructor)
	class UGameViewportClient*                         GameViewport;                                             // 0x0218(0x0008) (ZeroConstructor, IsPlainOldData)
	class UGameInstance*                               OwningGameInstance;                                       // 0x0220(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FNamedNetDriver>                     ActiveNetDrivers;                                         // 0x0228(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData03[0x40];                                      // 0x0238(0x0040) MISSED OFFSET
};
...
struct FAnimUpdateRateParameters
{
	...
	TMap<int, float>                                   AnimationFrameSkipToTreshold;                             // 0x0030(0x0050) (ZeroConstructor)
	TMap<int, int>                                     LODToFrameSkipMap;                                        // 0x0080(0x0050) (ZeroConstructor)
	int                                                SkippedUpdateFrames;                                      // 0x00D0(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SkippedEvalFrames;                                        // 0x00D4(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FAnimSlotDesc
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                NumChannels;                                              // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FAnimSlotInfo
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	TArray<float>                                      ChannelWeights;                                           // 0x0010(0x0010) (ZeroConstructor)
};
...
struct FPredictProjectilePathResult
{
	...
	struct FHitResult                                  HitResult;                                                // 0x002C(0x0090) (Edit, BlueprintVisible, BlueprintReadOnly, EditConst, IsPlainOldData)
...
struct FLevelSimplificationDetails
{
	...
	struct FMaterialProxySettings                      StaticMeshMaterialSettings;                               // 0x0008(0x0070) (Edit)
	bool                                               bOverrideLandscapeExportLOD;                              // 0x0078(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0079(0x0003) MISSED OFFSET
	int                                                LandscapeExportLOD;                                       // 0x007C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FMaterialProxySettings                      LandscapeMaterialSettings;                                // 0x0080(0x0070) (Edit)
	bool                                               bBakeFoliageToLandscape;                                  // 0x00F0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bBakeGrassToLandscape;                                    // 0x00F1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bGenerateMeshNormalMap;                                   // 0x00F2(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateMeshMetallicMap;                                 // 0x00F3(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateMeshRoughnessMap;                                // 0x00F4(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateMeshSpecularMap;                                 // 0x00F5(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateLandscapeNormalMap;                              // 0x00F6(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateLandscapeMetallicMap;                            // 0x00F7(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateLandscapeRoughnessMap;                           // 0x00F8(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateLandscapeSpecularMap;                            // 0x00F9(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
...
struct FClientReceiveData
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                MessageIndex;                                             // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FFunctionExpressionOutput
{
	...
	struct FExpressionOutput                           Output;                                                   // 0x0018(0x000C) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0024(0x0004) MISSED OFFSET
};
...
struct FScalarParameterAtlasInstanceData
{
	...
	unsigned char                                      UnknownData00[0x7];                                       // 0x0001(0x0007) MISSED OFFSET
	unsigned char                                      UnknownData01[0x30];                                      // 0x0001(0x0030) UNKNOWN PROPERTY: SoftObjectProperty Engine.ScalarParameterAtlasInstanceData.Curve
	unsigned char                                      UnknownData02[0x30];                                      // 0x0038(0x0030) UNKNOWN PROPERTY: SoftObjectProperty Engine.ScalarParameterAtlasInstanceData.Atlas
};
...
struct FMemberReference
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0018(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FGuid                                       MemberGuid;                                               // 0x0024(0x0010) (ZeroConstructor, IsPlainOldData)
	bool                                               bSelfContext;                                             // 0x0034(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bWasDeprecated;                                           // 0x0035(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	struct FName                                       Name;                                                     // 0x0038(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0038(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FColor                                      Color;                                                    // 0x0044(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     DefaultQueryExtent;                                       // 0x0048(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0054(0x0004) MISSED OFFSET
	class UClass*                                      NavigationDataClass;                                      // 0x0058(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	struct FSoftClassPath                              NavigationDataClassName;                                  // 0x0060(0x0020) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst)
};
...
struct FBeamTargetData
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              TargetPercentage;                                         // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
{
	unsigned char                                      UnknownData00[0x30];                                      // 0x0000(0x0030) UNKNOWN PROPERTY: SoftObjectProperty Engine.PreviewAttachedObjectPair.AttachedObject
	class UObject*                                     Object;                                                   // 0x0030(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FName                                       AttachedTo;                                               // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData)
...
struct FSpriteCategoryInfo
{
	...
	struct FText                                       Description;                                              // 0x0028(0x0018)
};
...
struct FRootMotionSource
{
	...
	unsigned char                                      UnknownData02[0x4];                                       // 0x0015(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              StartTime;                                                // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CurrentTime;                                              // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              PreviousTime;                                             // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              Duration;                                                 // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FRootMotionSourceStatus                     Status;                                                   // 0x0034(0x0001)
	struct FRootMotionSourceSettings                   Settings;                                                 // 0x0035(0x0001)
	bool                                               bInLocalSpace;                                            // 0x0036(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x9];                                       // 0x0037(0x0009) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0xC];                                       // 0x0094(0x000C) MISSED OFFSET
};
...
struct FClothingAssetData_Legacy
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	struct FString                                     ApexFileName;                                             // 0x0010(0x0010) (ZeroConstructor)
	bool                                               bClothPropertiesChanged;                                  // 0x0020(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0021(0x0003) MISSED OFFSET
	struct FClothPhysicsProperties_Legacy              PhysicsProperties;                                        // 0x0024(0x0050)
...
struct FSkeletalMeshClothBuildParams
{
	...
	unsigned char                                      UnknownData02[0x30];                                      // 0x0029(0x0030) UNKNOWN PROPERTY: SoftObjectProperty Engine.SkeletalMeshClothBuildParams.PhysicsAsset
};
...
struct FBoneMirrorExport
{
	struct FName                                       BoneName;                                                 // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       SourceBoneName;                                           // 0x000C(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<EAxis>                                 BoneFlipAxis;                                             // 0x0018(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FNameMapping
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       BoneName;                                                 // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
struct FReferencePose
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	TArray<struct FTransform>                          ReferencePose;                                            // 0x0010(0x0010) (ZeroConstructor)
};
...
struct FSplineInstanceData : public FSceneComponentInstanceData
{
	...
	struct FSplineCurves                               SplineCurves;                                             // 0x00B0(0x0060)
	struct FSplineCurves                               SplineCurvesPreUCS;                                       // 0x0110(0x0060)
};
