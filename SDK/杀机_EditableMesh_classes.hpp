...
#include "É±»ú_EditableMesh_structs.hpp"
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableMeshAdapter"));
...
{
public:
	class UGeometryCollection*                         GeometryCollection;                                       // 0x0030(0x0008) (ZeroConstructor, IsPlainOldData)
	class UGeometryCollection*                         OriginalGeometryCollection;                               // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                GeometryCollectionLODIndex;                               // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x9C];                                      // 0x0044(0x009C) MISSED OFFSET

	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableGeometryCollectionAdapter"));
...
public:
	...
	TArray<class UEditableMeshAdapter*>                Adapters;                                                 // 0x0330(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0340(0x0008) MISSED OFFSET
	int                                                TextureCoordinateCount;                                   // 0x0348(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x148];                                     // 0x034C(0x0148) MISSED OFFSET
	int                                                PendingCompactCounter;                                    // 0x0494(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SubdivisionCount;                                         // 0x0498(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1E4];                                     // 0x049C(0x01E4) MISSED OFFSET

	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableMesh"));
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableMeshFactory"));
...
public:
	...
	class UStaticMesh*                                 OriginalStaticMesh;                                       // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                StaticMeshLODIndex;                                       // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableStaticMeshAdapter"));
