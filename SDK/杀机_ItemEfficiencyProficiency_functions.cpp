...
#include "É±»ú_ItemEfficiencyProficiency_parameters.hpp"
...
EStatusEffectType UItemEfficiencyProficiency_C::GetType(float* value)
{
	static UFunction* fn;
	...
	UItemEfficiencyProficiency_C_GetType_Params params;
	params.value = value;
...
int UItemEfficiencyProficiency_C::GetLevel(class UChargeableInteractionDefinition** chargeableInteraction, class ADBDPlayer** Player)
{
	static UFunction* fn;
	...
	UItemEfficiencyProficiency_C_GetLevel_Params params;
	params.chargeableInteraction = chargeableInteraction;
	params.Player = Player;
...
bool UItemEfficiencyProficiency_C::GetIsActive(class UChargeableInteractionDefinition** chargeableInteraction, class ADBDPlayer** Player)
{
	static UFunction* fn;
	...
	UItemEfficiencyProficiency_C_GetIsActive_Params params;
	params.chargeableInteraction = chargeableInteraction;
	params.Player = Player;
