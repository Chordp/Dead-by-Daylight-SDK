...
#include "É±»ú_BP_Menu_Slasher17_parameters.hpp"
...
void ABP_Menu_Slasher17_C::ReceiveBeginPlay()
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher17.BP_Menu_Slasher17_C.ReceiveBeginPlay"));
...
void ABP_Menu_Slasher17_C::ExecuteUbergraph_BP_Menu_Slasher17(int* EntryPoint)
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher17.BP_Menu_Slasher17_C.ExecuteUbergraph_BP_Menu_Slasher17"));
