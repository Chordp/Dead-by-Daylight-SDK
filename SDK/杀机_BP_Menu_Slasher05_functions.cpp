...
#include "É±»ú_BP_Menu_Slasher05_parameters.hpp"
...
void ABP_Menu_Slasher05_C::ReceiveBeginPlay()
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher05.BP_Menu_Slasher05_C.ReceiveBeginPlay"));
...
void ABP_Menu_Slasher05_C::ExecuteUbergraph_BP_Menu_Slasher05(int* EntryPoint)
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_Menu_Slasher05.BP_Menu_Slasher05_C.ExecuteUbergraph_BP_Menu_Slasher05"));
