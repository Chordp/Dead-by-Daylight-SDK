...
struct FTransformConstraint
{
	...
	unsigned char                                      UnknownData01[0x4];                                       // 0x000D(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       TargetNode;                                               // 0x001C(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bMaintainOffset;                                          // 0x002C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FNodeObject
{
	...
	struct FName                                       ParentName;                                               // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData)
