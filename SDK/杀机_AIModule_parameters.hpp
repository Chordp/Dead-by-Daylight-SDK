...
#include "É±»ú_AIModule_classes.hpp"
...
struct UEQSRenderingComponent_SetRenderCustomColourNoDepth_Params
{
	bool*                                              bValue;                                                   // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UEQSRenderingComponent_SetCustomColourWriteMask_Params
{
