...
#include "É±»ú_ConsecutiveWakeUpPenaltyProficiency_parameters.hpp"
...
EStatusEffectType UConsecutiveWakeUpPenaltyProficiency_C::GetType(float* value)
{
	static UFunction* fn;
	...
	UConsecutiveWakeUpPenaltyProficiency_C_GetType_Params params;
	params.value = value;
...
int UConsecutiveWakeUpPenaltyProficiency_C::GetLevel(class UChargeableInteractionDefinition** chargeableInteraction, class ADBDPlayer** Player)
{
	static UFunction* fn;
	...
	UConsecutiveWakeUpPenaltyProficiency_C_GetLevel_Params params;
	params.chargeableInteraction = chargeableInteraction;
	params.Player = Player;
...
bool UConsecutiveWakeUpPenaltyProficiency_C::GetIsActive(class UChargeableInteractionDefinition** chargeableInteraction, class ADBDPlayer** Player)
{
	static UFunction* fn;
	...
	UConsecutiveWakeUpPenaltyProficiency_C_GetIsActive_Params params;
	params.chargeableInteraction = chargeableInteraction;
	params.Player = Player;
